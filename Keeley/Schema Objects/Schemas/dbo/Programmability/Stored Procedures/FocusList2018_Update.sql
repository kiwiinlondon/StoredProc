...
IF EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[FocusList2018_Update]')
AND OBJECTPROPERTY(id, N'IsProcedure') = 1)

DROP PROCEDURE DBO.[FocusList2018_Update]
GO

CREATE PROCEDURE DBO.[FocusList2018_Update]
		@FocusListId int, 
