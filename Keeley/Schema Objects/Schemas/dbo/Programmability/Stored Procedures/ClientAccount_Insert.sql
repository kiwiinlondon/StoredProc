...
AS
	...
	INSERT into ClientAccount
			(ClientId, AccountReference, AdministratorId, Name, CountryId, UpdateUserID, IsActive, ParentClientAccountId, StaffId, FundId, ManualUpdate, ClientHasChanged, StartDt)
	VALUES
			(@ClientId, @AccountReference, @AdministratorId, @Name, @CountryId, @UpdateUserID, @IsActive, @ParentClientAccountId, @StaffId, @FundId, @ManualUpdate, @ClientHasChanged, @StartDt)
