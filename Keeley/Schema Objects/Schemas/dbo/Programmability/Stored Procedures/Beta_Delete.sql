...
AS
	...
	SELECT	BetaId, AnalyticTypeId, InstrumentMarketId, RelativeIndexInstrumentMarketId, CurrencyId, ReferenceDate, Value, StartDt, UpdateUserID, DataVersion, UpdateDate, UpdatedOnReferenceDay, @EndDt, @UpdateUserID
	FROM	Beta
	WHERE	BetaId = @BetaId
