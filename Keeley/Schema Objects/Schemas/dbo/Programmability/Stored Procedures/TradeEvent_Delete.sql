...
AS
	...
	SELECT	EventID, InstrumentMarketID, TradeDate, SettlementDate, TraderId, Quantity, Price, FXRate, CurrencyId, CounterpartyId, StartDt, UpdateUserID, DataVersion, @EndDt, @UpdateUserID
	FROM	TradeEvent
