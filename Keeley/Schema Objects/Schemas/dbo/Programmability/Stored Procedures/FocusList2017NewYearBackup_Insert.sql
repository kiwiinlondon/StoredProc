...
IF EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[FocusList2017NewYearBackup_Insert]')
AND OBJECTPROPERTY(id, N'IsProcedure') = 1)

DROP PROCEDURE DBO.[FocusList2017NewYearBackup_Insert]
GO

CREATE PROCEDURE DBO.[FocusList2017NewYearBackup_Insert]
...
AS
	...
	INSERT into FocusList2017NewYearBackup
