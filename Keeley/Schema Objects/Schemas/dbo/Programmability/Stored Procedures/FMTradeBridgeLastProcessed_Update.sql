...
AS
	...
	SELECT	FMTradeBridgeLastProcessedId, LastContEventId, MaxInputDate, DataVersion, IsTrade, LastProcessedTime, @StartDt, @UpdateUserID
	...
	SET		LastContEventId = @LastContEventId, MaxInputDate = @MaxInputDate, IsTrade = @IsTrade, LastProcessedTime = @LastProcessedTime,  StartDt = @StartDt
	WHERE	FMTradeBridgeLastProcessedId = @FMTradeBridgeLastProcessedId
