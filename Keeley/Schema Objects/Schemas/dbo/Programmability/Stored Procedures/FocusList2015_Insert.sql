...
IF EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[FocusList2015_Insert]')
AND OBJECTPROPERTY(id, N'IsProcedure') = 1)

DROP PROCEDURE DBO.[FocusList2015_Insert]
GO

CREATE PROCEDURE DBO.[FocusList2015_Insert]
