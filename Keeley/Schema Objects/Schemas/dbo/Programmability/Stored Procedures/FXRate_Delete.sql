...
AS
	...
	SELECT	FXRateId, FromCurrencyId, ToCurrencyId, ReferenceDate, EntityRankingSchemeId, ForwardDate, RawFXRateId, RawFXRate2Id, Value, StartDt, UpdateUserID, DataVersion, @EndDt, @UpdateUserID
	FROM	FXRate
