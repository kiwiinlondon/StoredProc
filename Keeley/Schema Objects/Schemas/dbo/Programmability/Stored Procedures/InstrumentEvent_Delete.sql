...
AS
	...
	SELECT	EventID, InstrumentMarketID, InstrumentEventTypeID, EventDate, ValueDate, Quantity, Price, FXRate, CurrencyId, StartDt, UpdateUserID, DataVersion, @EndDt, @UpdateUserID
