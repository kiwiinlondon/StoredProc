...
AS
	...
	SELECT	FactorExposureId, FactorRelationshipId, FactorBenchmarkId, ReferenceDate, FundId, InstrumentMarketId, PortfolioVolatility, BenchmarkVolatility, TrackingError, ActiveExposure, MarginalX100, FactorVolatility, TotalActiveVolatility, VolatilityContribution, StartDt, UpdateUserId, DataVersion, @EndDt, @UpdateUserID
	FROM	FactorExposure
