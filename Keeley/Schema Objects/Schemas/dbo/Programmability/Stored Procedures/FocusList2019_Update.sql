...
IF EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[FocusList2019_Update]')
AND OBJECTPROPERTY(id, N'IsProcedure') = 1)

DROP PROCEDURE DBO.[FocusList2019_Update]
GO

CREATE PROCEDURE DBO.[FocusList2019_Update]
		@FocusListId int, 
