...
IF EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[FocusList2018_Insert]')
AND OBJECTPROPERTY(id, N'IsProcedure') = 1)

DROP PROCEDURE DBO.[FocusList2018_Insert]
GO

CREATE PROCEDURE DBO.[FocusList2018_Insert]
