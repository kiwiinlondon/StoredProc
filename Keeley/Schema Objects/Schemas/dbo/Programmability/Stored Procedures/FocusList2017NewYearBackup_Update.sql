...
IF EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[FocusList2017NewYearBackup_Update]')
AND OBJECTPROPERTY(id, N'IsProcedure') = 1)

DROP PROCEDURE DBO.[FocusList2017NewYearBackup_Update]
GO

CREATE PROCEDURE DBO.[FocusList2017NewYearBackup_Update]
		@FocusListId int, 
...
AS
	...
	UPDATE	FocusList2017NewYearBackup
