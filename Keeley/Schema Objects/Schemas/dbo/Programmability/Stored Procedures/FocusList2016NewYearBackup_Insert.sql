...
IF EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[FocusList2016NewYearBackup_Insert]')
AND OBJECTPROPERTY(id, N'IsProcedure') = 1)

DROP PROCEDURE DBO.[FocusList2016NewYearBackup_Insert]
GO

CREATE PROCEDURE DBO.[FocusList2016NewYearBackup_Insert]
...
AS
	...
	INSERT into FocusList2016NewYearBackup
