...
IF EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[PortfolioOld_Insert]')
AND OBJECTPROPERTY(id, N'IsProcedure') = 1)

DROP PROCEDURE DBO.[PortfolioOld_Insert]
GO

CREATE PROCEDURE DBO.[PortfolioOld_Insert]
		@PositionID int, 
